...
%onevel=70;
%v0 = 0; %propulsion velocity, microns/s
...
omegadiststdev = 2*pi*200/4; %standard deviation of each component of propulsion angular velocity
                     %units rad/s
                     %note 2*pi*200/2 is best msd so far, but needs vel>70,
                     %whuch increases msd
                     %2*pi*200/4 gives good step size, MSD is about 5 at
                     %0.1 after avg
                     %2*pi*200/4 ~ 2*pi*267/5.34, i.e., 1/5.34 of a
                     %rotation in a frame at 267fps which is consistent
                     %with videos
